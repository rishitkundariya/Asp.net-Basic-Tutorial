<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckBoxList_Example.aspx.cs" Inherits="CheckBoxList_Example" %>
...
<body>
    <form id="form1" runat="server">
         <div class="container">
            ...
            <div class="row" style="padding-top:20px;">
                <div class="col-md-4 ">
                    <asp:CheckBoxList ID="cblLeft" runat="server" CellPadding="5" CellSpacing="5"></asp:CheckBoxList>
                </div>
                <div class="col-md-1"> 
                ...
                <div class="col-md-4">
                    <asp:CheckBoxList ID="cblRight" runat="server" CellPadding="5" CellSpacing="5" ></asp:CheckBoxList>
                </div>
